...
func _unsafe(method func(frame *rtdata.Frame), name, desc string) {
	native.Register("sun/misc/Unsafe", name, desc, method)
}

// public native long allocateMemory(long bytes);
// (J)J
func allocateMemory(frame *rtdata.Frame) {
...
// (JJ)J
func reallocateMemory(frame *rtdata.Frame) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
...
// (J)V
func freeMemory(frame *rtdata.Frame) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
	address := vars.GetLong(1)
	free(address)
...
//// (JJ)V
//func putAddress(frame *rtdata.Frame) {
//	mem_putLong(frame)
//}
//
//// public native long getAddress(long address);
//// (J)J
//func getAddress(frame *rtdata.Frame) {
//	mem_getLong(frame)
//}
//
//// public native void putByte(long address, byte x);
//// (JB)V
//func mem_putByte(frame *rtdata.Frame) {
...
// (J)B
func mem_getByte(frame *rtdata.Frame) {
...
//// (JS)V
//func mem_putShort(frame *rtdata.Frame) {
//	mem, value := _put(frame)
...
//// (J)S
//func mem_getShort(frame *rtdata.Frame) {
//	stack, mem := _get(frame)
...
//// (JC)V
//func mem_putChar(frame *rtdata.Frame) {
//	mem, value := _put(frame)
...
//// (J)C
//func mem_getChar(frame *rtdata.Frame) {
//	stack, mem := _get(frame)
...
//// (JI)V
//func mem_putInt(frame *rtdata.Frame) {
//	mem, value := _put(frame)
...
//// (J)I
//func mem_getInt(frame *rtdata.Frame) {
//	stack, mem := _get(frame)
...
// (JJ)V
func mem_putLong(frame *rtdata.Frame) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
	address := vars.GetLong(1)
...
//// (J)J
//func mem_getLong(frame *rtdata.Frame) {
//	stack, mem := _get(frame)
...
//// (JJ)V
//func mem_putFloat(frame *rtdata.Frame) {
//	mem, value := _put(frame)
...
//// (J)J
//func mem_getFloat(frame *rtdata.Frame) {
//	stack, mem := _get(frame)
...
//// (JJ)V
//func mem_putDouble(frame *rtdata.Frame) {
//	mem, value := _put(frame)
...
//// (J)J
//func mem_getDouble(frame *rtdata.Frame) {
//	stack, mem := _get(frame)
//	stack.PushDouble(Float64(mem))
//}
//
//func _put(frame *rtdata.Frame) ([]byte, interface{}) {
//	vars := frame.LocalVars()
//	// vars.GetRef(0) // this
//	address := vars.GetLong(1)
//	value := vars.Get(3)
...
//}
//
func _get(frame *rtdata.Frame) (*rtdata.OperandStack, []byte) {
	vars := frame.LocalVars()
	// vars.GetRef(0) // this
	address := vars.GetLong(1)
