...
// (Ljava/lang/Class;)I
func arrayBaseOffset(frame *rtdata.Frame) {
...
// (Ljava/lang/Class;)I
func arrayIndexScale(frame *rtdata.Frame) {
	stack := frame.OperandStack()
...
// ()I
func addressSize(frame *rtdata.Frame) {
...
func objectFieldOffset(frame *rtdata.Frame) {
	vars := frame.LocalVars()
...
func compareAndSwapObject(frame *rtdata.Frame) {
	vars := frame.LocalVars()
	obj := vars.GetRef(1)
	fields := obj.Data()
...
func getInt(frame *rtdata.Frame) {
	vars := frame.LocalVars()
...
func compareAndSwapInt(frame *rtdata.Frame) {
	vars := frame.LocalVars()
	fields := vars.GetRef(1).Data()
	offset := vars.GetLong(2)
...
func getObject(frame *rtdata.Frame) {
	vars := frame.LocalVars()
	fields := vars.GetRef(1).Data()
	offset := vars.GetLong(2)
...
func compareAndSwapLong(frame *rtdata.Frame) {
	vars := frame.LocalVars()
	fields := vars.GetRef(1).Data()
	offset := vars.GetLong(2)
